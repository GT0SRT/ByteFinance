    ...
    <div className="min-h-screen flex items-center justify-center bg-black relative overflow-hidden px-4 py-8">
      ...
      >
        ...
        <div className="text-center mb-6">
          <div
            className="w-12 h-12 rounded-2xl mx-auto flex flex-col items-center justify-center mb-3 text-white/80"
          >
            <span className="text-2xl font-bold text-[#FFD700] p-1"><Coins /></span>
            ByteFinance
          </div>
          ...
          <p className="text-gray-400 text-xs">
            {isLogin ? 'Access your financial dashboard' : 'Join the future of instant lending'}
          </p>
        </div>
